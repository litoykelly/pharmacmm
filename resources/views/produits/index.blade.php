           ...
           <tbody>
              @foreach ($produits as $produit )
               <tr>
                 ...
                 <td>{{$produit->prix_unitaire}} CDF</td>
                 

                 <td>
                    <a href="{{route('produits.edit',$produit->id)}}" class="btn btn-success"> Modifier </a>
                    {{-- <a href="{{route('produits.edit ',$produit->id)}}" class="btn btn-danger"> Suppimer </a> --}}
                 </td>
              </tr>  
              @endforeach
          </tbody>
