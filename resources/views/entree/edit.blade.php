    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('entree.update',$entree->id) }}">
                            ...
                            <label for="nom_fourni" class="col-md-4 col-form-label text-md-end">{{ __('Fournisseur') }} </label>
                             ...
                             <div class="col-md-6">
                                 <select name="fournisseur_id" id="fournisseur_id" class="form-control @error('fournisseur_id') is-invalid @enderror" 
                                         value="{{ old('fournisseur_id',$entree->fournisseur_id) }}" required >
                                   
                                  <option value="1">Fournisseur</option>
                                    <option value="2">Dépot</option>   
                                 </select>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                 <select name="medicament_id" id="medicament_id" class="form-control @error('medicament_id') is-invalid @enderror" 
                                         value="{{ old('medicament_id',$entree->medicament_id) }}" required >
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="num_lot" type="text" class="form-control @error('num_lot') is-invalid @enderror" name="num_lot" 
                                     value="{{ old('num_lot',$entree->num_lot) }}" required >
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="date_exp" type="text" class="form-control @error('date_exp') is-invalid @enderror" name="date_exp" 
                                       value="{{ old('date_exp',$entree->date_exp) }}" required > 
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="qty_ee" type="text" class="form-control @error('qty_ee') is-invalid @enderror" name="qty_ee" 
                                       value="{{ old('qty_ee',$entree->qty_ee) }}" required > 
                         ...
                         <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="date_appro" type="text" class="form-control @error('date_appro') is-invalid @enderror" name="date_appro" 
                                       value="{{ old('date_appro',$entree->date_appro) }}" required > 
            ...
            <form method="POST" action="{{ route('entree.destroy',$entree->id) }}"> 
            @csrf
            @method ('DELETE') 
